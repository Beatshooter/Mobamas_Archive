...
(lib.bg = function() {
	this.initialize(img._419_3_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ch_base = function() {
	this.initialize(img._419_3_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);


(lib.ch_face2 = function() {
	this.initialize(img._419_3_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face3 = function() {
	this.initialize(img._419_3_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face4 = function() {
	this.initialize(img._419_3_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face5 = function() {
	this.initialize(img._419_3_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face6 = function() {
	this.initialize(img._419_3_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face7 = function() {
	this.initialize(img._419_3_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face8 = function() {
	this.initialize(img._419_3_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.finish = function() {
	this.initialize(img._419_3_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._419_3_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._419_3_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._419_3_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,190,190), null);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("Au1O2IAA9rIdrAAIAAdrg");
	mask.setTransform(96,96);
...
p.nominalBounds = new cjs.Rectangle(1,1,190,190);
...
(lib.window = function(mode,startPosition,loop) {
	...
	// dummy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(40.1,11.775);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(58.6,236.95,0.0766,0.0766);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(38.45,179.8,0.1958,0.1958);
	this.instance_1._off = true;
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(219.25,214,0.1618,0.1618);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(204.65,15.95,0.1362,0.1362);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(8.55,107.95,0.1106,0.1106);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(229.3,172.7,0.1702,0.1702);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(216.45,36.6,0.2555,0.2555);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(177.55,242.95,0.1176,0.1176);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("ADoDLQhRhFhwg9Qhgg0gFAGQgNAvhAAxQiCBikEAKQiggghrhRQh1hZADhwQAEi5FZAjQBaAJDDBIQC8BFAKAAQAJAADMhPQDPhRBPgCQHPgOAQBZQARBggIBKQgMBvhEAnQhkA6i8AdQhKALg7AAQh2AAg6gtg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:96.2879,y:87.6636}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:95,regY:95,x:95,y:95,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:95,regY:95,x:95,y:95,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:96,regY:96,x:96,y:96,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:96,regY:96,x:96,y:96,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-204,-204,600,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-205,-164);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-325,-560,635.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(7).call(this.frame_449).wait(1).call(this.frame_450).wait(15).call(this.frame_465).wait(1).call(this.frame_466).wait(19).call(this.frame_485).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-81.85,-350.65,1.1645,1.1645);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-107.45,y:-359.65,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-119.1,y:-363.95,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-81.85,y:-350.65,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-107.45,y:-359.65,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-119.1,y:-363.95,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-81.85,y:-350.65,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-107.45,y:-359.65,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-119.1,y:-363.95,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-81.85,y:-350.65,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-107.45,y:-359.65,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-119.1,y:-363.95,alpha:0.2188},0).to({_off:true},1).wait(110).to({_off:false,rotation:0,x:-81.85,y:-350.65,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-107.45,y:-359.65,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-119.1,y:-363.95,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-81.85,y:-350.65,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-107.45,y:-359.65,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-119.1,y:-363.95,alpha:0.2188},0).to({_off:true},1).wait(37));

	// effect
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-27.7,-256.5,1.4808,1.4808);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-27.7,-256.5,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-138.25,-329.8,1.7208,1.7208,0,-164.0161,15.9839,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-120.3,-341.25,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-92.5,-258.9,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-93.15,-343.5,1.053,1.053,-28.4906);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-95.4,-358.2,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-89.9,-339.6,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-83.65,-340.9,0.9876,0.9876,14.9998);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-93.25,-344.55,1.3878,1.3878,-121.2396);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-70.75,-190.15);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-92.55,-299.75,0.4532,0.4532);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(45.4,-319.85,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-85.65,-369,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(-27.95,-257.05,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},16).wait(20));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-137.65,y:-329.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-138.25,y:-329.8,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.187,scaleY:1.187,skewX:-169.8305,skewY:10.1695,x:-99.4,y:-346.55,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-99,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-99.4,alpha:0},0).to({_off:true},1).wait(327));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-122.8,y:-340.4,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-120.3,y:-341.25,alpha:0,startPosition:19},0).to({_off:true},1).wait(306));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-100.1,y:-356.9,alpha:0.5556},0).wait(1).to({x:-104.2,y:-365.15,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-105.5,y:-368.2,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-105.25,y:-367.25},0).wait(1).to({x:-104.25,y:-365.4},0).wait(1).to({x:-102.55,y:-362.25},0).wait(1).to({regX:0,regY:0,x:-100.1,y:-358.2},0).to({x:-100.85,y:-359.55},2).wait(8).to({regX:-0.2,regY:0.2,x:-100.6,y:-358.65,alpha:0.9298},0).wait(1).to({x:-99.55,y:-356.7,alpha:0.692},0).wait(1).to({x:-97.95,y:-353.8,alpha:0.339},0).wait(1).to({x:-96.8,y:-351.65,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-96.35,y:-351.35,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-93.6,y:-343.1},0).wait(1).to({regX:-0.2,regY:0.2,x:-100.55,y:-356.5,alpha:0.5556},0).wait(1).to({x:-104.65,y:-364.75,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-105.95,y:-367.8,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-105.7,y:-366.85},0).wait(1).to({x:-104.7,y:-365},0).wait(1).to({x:-103,y:-361.85},0).wait(1).to({regX:0,regY:0,x:-100.55,y:-357.8},0).to({x:-101.3,y:-359.15},2).wait(3).to({regX:-0.2,regY:0.2,x:-101.05,y:-358.25,alpha:0.9298},0).wait(1).to({x:-100,y:-356.3,alpha:0.692},0).wait(1).to({x:-98.4,y:-353.4,alpha:0.339},0).wait(1).to({x:-97.25,y:-351.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-96.8,y:-350.95,alpha:0},0).to({_off:true},1).wait(239));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-88.9,y:-335.9},0).wait(1).to({y:-332.05},0).wait(1).to({y:-328.8},0).wait(1).to({y:-326.15},0).wait(1).to({y:-324.05},0).wait(1).to({y:-322.55},0).wait(1).to({y:-321.65},0).wait(1).to({regX:-0.5,regY:0.2,x:-89.9,y:-320.6},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-88.9,y:-321.4,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-89.9,y:-320.6,alpha:0},0).to({_off:true},1).wait(197));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-115.075,y:-336.2875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-125.55,y:-334.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-83.65,y:-340.9,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-115.075,y:-340.675,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-125.55,y:-340.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-83.65,y:-340.9,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-115.075,y:-336.2875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-125.55,y:-334.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-83.65,y:-340.9,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-115.075,y:-340.675,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-125.55,y:-340.6,alpha:0.2188},0).to({_off:true},1).wait(110).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-83.65,y:-340.9,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-115.075,y:-336.2875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-125.55,y:-334.75,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-83.65,y:-340.9,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-115.075,y:-340.675,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-125.55,y:-340.6,alpha:0.2188},0).to({_off:true},1).wait(37));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:-71.75,y:-189.15,alpha:1},0).wait(1).to({regX:0.9,x:-71.85,y:-188.2,alpha:0.8965},0).wait(1).to({x:-73.2,y:-187,alpha:0.7636},0).wait(1).to({x:-74.8,y:-185.55,alpha:0.6048},0).wait(1).to({x:-76.6,y:-183.95,alpha:0.4229},0).wait(1).to({x:-78.6,y:-182.1,alpha:0.2205},0).wait(1).to({regX:0,x:-81.75,y:-180.15,alpha:0},0).to({_off:true},1).wait(127));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-94.3,y:-313.9},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-97.55,y:-319.75},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-95,y:-317.6},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-94.45,y:-314.35},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-95.55,y:-309.75},0).to({scaleX:1,scaleY:1,x:-96.55,y:-313.75},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-93.95,y:-312.75,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-95.55,y:-313.5,alpha:0.1016},0).to({_off:true},1).wait(103));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-323.6},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-324.85},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-25,regY:-210,x:-25,y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-215.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-215.75},0).wait(1).to({y:-208.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-206.75},0).wait(1).to({y:-209.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-214.95},0).wait(1).to({y:-209.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-214.95},0).wait(1).to({y:-209.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-209.1},0).wait(1).to({y:-209.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-222.95},0).wait(1).to({y:-219.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-208},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-210.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-222.95},0).wait(1).to({y:-219.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-208},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-210.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-25,regY:-210,x:-25,y:-209.4},0).wait(1).to({y:-207},0).wait(1).to({y:-204.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-204.65},0).wait(1).to({y:-207},0).wait(1).to({y:-209.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-25,regY:-210,x:-25,y:-209.85},0).wait(1).to({y:-209.3},0).wait(1).to({y:-208.2},0).wait(1).to({y:-206.85},0).wait(1).to({y:-205.75},0).wait(1).to({y:-205.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-205.2},0).wait(1).to({y:-205.75},0).wait(1).to({y:-206.85},0).wait(1).to({y:-208.2},0).wait(1).to({y:-209.3},0).wait(1).to({y:-209.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-25,regY:-210,x:-25,y:-205.25},0).wait(1).to({y:-208.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-25,regY:-210,x:-25,y:-207.8},0).wait(1).to({y:-209.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-25,regY:-210,rotation:-0.0253,x:-25.1,y:-209.95},0).wait(1).to({rotation:-0.1129,x:-25.3,y:-209.6},0).wait(1).to({rotation:-0.2845,x:-25.7,y:-209},0).wait(1).to({rotation:-0.5565,x:-26.35,y:-208},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-27.15,y:-206.7},0).wait(1).to({rotation:-1.2075,x:-27.85,y:-205.55},0).wait(1).to({rotation:-1.4141,x:-28.4,y:-204.75},0).wait(1).to({rotation:-1.5201,x:-28.6,y:-204.35},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-25,regY:-210,rotation:-1.5305,x:-28.65,y:-204.35},0).wait(1).to({rotation:-1.4624,x:-28.5,y:-204.55},0).wait(1).to({rotation:-1.3309,x:-28.15,y:-205.05},0).wait(1).to({rotation:-1.121,x:-27.7,y:-205.9},0).wait(1).to({rotation:-0.8372,x:-27,y:-206.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-26.3,y:-208.1},0).wait(1).to({rotation:-0.2881,x:-25.75,y:-209},0).wait(1).to({rotation:-0.1291,x:-25.35,y:-209.65},0).wait(1).to({rotation:-0.0467,x:-25.15,y:-209.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-25,regY:-210,rotation:-0.0253,x:-25.1,y:-209.95},0).wait(1).to({rotation:-0.1129,x:-25.3,y:-209.6},0).wait(1).to({rotation:-0.2845,x:-25.7,y:-209},0).wait(1).to({rotation:-0.5565,x:-26.35,y:-208},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-27.15,y:-206.7},0).wait(1).to({rotation:-1.2075,x:-27.85,y:-205.55},0).wait(1).to({rotation:-1.4141,x:-28.4,y:-204.75},0).wait(1).to({rotation:-1.5201,x:-28.6,y:-204.35},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-25,regY:-210,rotation:-1.5302,x:-28.65,y:-204.35},0).wait(1).to({rotation:-1.461,x:-28.5,y:-204.55},0).wait(1).to({rotation:-1.3276,x:-28.15,y:-205.05},0).wait(1).to({rotation:-1.1146,x:-27.7,y:-205.9},0).wait(1).to({rotation:-0.8266,x:-27,y:-206.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-26.25,y:-208.1},0).wait(1).to({rotation:-0.2693,x:-25.7,y:-209.05},0).wait(1).to({rotation:-0.1079,x:-25.3,y:-209.65},0).wait(1).to({rotation:-0.0243,x:-25.1,y:-209.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-25,regY:-210,x:-25,y:-215.55},0).wait(1).to({y:-217.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-217.35},0).wait(1).to({y:-215.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-25,regY:-210,x:-25,y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-25,regY:-210,rotation:-0.0253,x:-25.1,y:-209.9},0).wait(1).to({rotation:-0.1129,x:-25.3,y:-209.3},0).wait(1).to({rotation:-0.2845,x:-25.7,y:-208.25},0).wait(1).to({rotation:-0.5565,x:-26.35,y:-206.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-27.15,y:-204.35},0).wait(1).to({rotation:-1.2075,x:-27.85,y:-202.4},0).wait(1).to({rotation:-1.4141,x:-28.4,y:-201.1},0).wait(1).to({rotation:-1.5201,x:-28.6,y:-200.45},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:-25,regY:-210,rotation:-1.5305,x:-28.65,y:-200.4},0).wait(1).to({rotation:-1.4624,x:-28.5,y:-200.8},0).wait(1).to({rotation:-1.3309,x:-28.15,y:-201.6},0).wait(1).to({rotation:-1.121,x:-27.7,y:-203},0).wait(1).to({rotation:-0.8372,x:-27,y:-204.85},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-26.3,y:-206.75},0).wait(1).to({rotation:-0.2881,x:-25.75,y:-208.3},0).wait(1).to({rotation:-0.1291,x:-25.35,y:-209.35},0).wait(1).to({rotation:-0.0467,x:-25.15,y:-209.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-25,regY:-210,rotation:-0.147,x:-25.4,y:-209.5},0).wait(1).to({rotation:-0.7239,x:-26.75,y:-207.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-28.3,y:-204.9},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-25,regY:-210,rotation:-1.4913,x:-28.55,y:-204.45},0).wait(1).to({rotation:-1.2701,x:-28.05,y:-205.3},0).wait(1).to({rotation:-0.8372,x:-27,y:-206.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-25.9,y:-208.75},0).wait(1).to({rotation:-0.094,x:-25.3,y:-209.75},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-25,regY:-210,rotation:-0.0894,x:-25.25,y:-209.7},0).wait(1).to({rotation:-0.4358,x:-26.05,y:-208.4},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-27.5,y:-206.2},0).wait(1).to({rotation:-1.4426,x:-28.45,y:-204.6},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-25,regY:-210,rotation:-1.4913,x:-28.55,y:-204.45},0).wait(1).to({rotation:-1.2701,x:-28.05,y:-205.3},0).wait(1).to({rotation:-0.8372,x:-27,y:-206.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-25.9,y:-208.75},0).wait(1).to({rotation:-0.094,x:-25.3,y:-209.75},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-25,regY:-210,x:-27.75,y:-202.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-25,regY:-210,x:-25,y:-197.75},0).wait(1).to({y:-200.7},0).wait(1).to({y:-205.65},0).wait(1).to({y:-209.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-209},0).wait(1).to({y:-203.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-25,regY:-210,x:-25,y:-202.2},0).wait(1).to({y:-206.5},0).wait(1).to({y:-210.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-210.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-25,regY:-210,x:-25,y:-216.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-216.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-25,regY:-210,x:-27.75,y:-202.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-25,regY:-210,x:-25,y:-199.25},0).wait(1).to({y:-207},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-211},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-210.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-209.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-25,regY:-210,x:-25,y:-209.4},0).wait(1).to({y:-207},0).wait(1).to({y:-204.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-204.6},0).wait(1).to({y:-204.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-25,regY:-210,x:-25,y:-205.4},0).wait(1).to({y:-206.9},0).wait(1).to({y:-209.15},0).wait(1).to({y:-210.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-210.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-217.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-25,regY:-210,x:-25,y:-217.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-25,regY:-210,x:-25,y:-218},0).wait(1).to({y:-212},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-25,regY:-210,x:-25,y:-205.35},0).wait(1).to({y:-206.55},0).wait(1).to({y:-208.5},0).wait(1).to({y:-209.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-214.95},0).wait(1).to({y:-209.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-214.95},0).wait(1).to({y:-209.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-209.1},0).wait(1).to({y:-209.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-25,regY:-210,x:-22,y:-206.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-25,regY:-210,x:-25.85,y:-200.55},0).wait(1).to({x:-25.2,y:-200.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-25,regY:-210,x:-25,y:-200.7},0).wait(1).to({y:-203.15},0).wait(1).to({y:-206.85},0).wait(1).to({y:-209.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:-25,regY:-210,x:-25,y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(2).to({regX:-25,regY:-210,x:-25,y:-218.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-25,regY:-210,x:-25,y:-219.2},0).wait(1).to({y:-216.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(29));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,836.5999999999999,838.2);
...
// stage content:
(lib._419_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:179,scene2:180,end2:325,scene3:326,end3:488,scene4:489,end4:666,scene5:667,end5:801,scene6:802,end6:956,scene7:957,end7:1180});
	...
	this.frame_489 = function() {
		...
		exportRoot._u.setFace("ch2", 8);
		this.ch2.gotoAndPlay("chord_jump");
	}
	this.frame_519 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "かったら､";
		exportRoot._u.setText();
	...
	this.frame_584 = function() {
		exportRoot._g.m3 = "わよ! ﾌﾌﾝ､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 6);
	}
	this.frame_601 = function() {
		exportRoot._g.m3 = "わよ! ﾌﾌﾝ､魔女の言葉は､";
		exportRoot._u.setText();
	...
	this.frame_990 = function() {
		exportRoot._g.m1 = "でも……そうね､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 7);
	}
	this.frame_1013 = function() {
		exportRoot._g.m1 = "でも……そうね､いいわ｡";
		exportRoot._u.setText();
	...
	this.frame_1039 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "くだから､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 8);
	}
	this.frame_1061 = function() {
		exportRoot._g.m2 = "くだから､お返しをあげる! ";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(25).call(this.frame_40).wait(27).call(this.frame_67).wait(26).call(this.frame_93).wait(33).call(this.frame_126).wait(16).call(this.frame_142).wait(14).call(this.frame_156).wait(23).call(this.frame_179).wait(1).call(this.frame_180).wait(17).call(this.frame_197).wait(17).call(this.frame_214).wait(32).call(this.frame_246).wait(40).call(this.frame_286).wait(25).call(this.frame_311).wait(14).call(this.frame_325).wait(1).call(this.frame_326).wait(14).call(this.frame_340).wait(25).call(this.frame_365).wait(19).call(this.frame_384).wait(50).call(this.frame_434).wait(13).call(this.frame_447).wait(24).call(this.frame_471).wait(17).call(this.frame_488).wait(1).call(this.frame_489).wait(30).call(this.frame_519).wait(22).call(this.frame_541).wait(43).call(this.frame_584).wait(17).call(this.frame_601).wait(16).call(this.frame_617).wait(21).call(this.frame_638).wait(12).call(this.frame_650).wait(16).call(this.frame_666).wait(1).call(this.frame_667).wait(16).call(this.frame_683).wait(38).call(this.frame_721).wait(11).call(this.frame_732).wait(35).call(this.frame_767).wait(13).call(this.frame_780).wait(21).call(this.frame_801).wait(1).call(this.frame_802).wait(13).call(this.frame_815).wait(10).call(this.frame_825).wait(13).call(this.frame_838).wait(24).call(this.frame_862).wait(10).call(this.frame_872).wait(22).call(this.frame_894).wait(23).call(this.frame_917).wait(8).call(this.frame_925).wait(31).call(this.frame_956).wait(1).call(this.frame_957).wait(33).call(this.frame_990).wait(23).call(this.frame_1013).wait(26).call(this.frame_1039).wait(22).call(this.frame_1061).wait(32).call(this.frame_1093).wait(54).call(this.frame_1147).wait(16).call(this.frame_1163).wait(17).call(this.frame_1180).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1180).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1185));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({alpha:0.1016},3).to({_off:true},1).wait(1166));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1106).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1146).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(26));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1146).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1146).to({_off:false},0).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1146).to({_off:false},0).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1134).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(938).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(220));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(492).to({regX:0,scaleX:1.1997,scaleY:1.1997,rotation:-4.2598,x:145.75,y:-12.2},35).to({_off:true},604).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({scaleX:0.5698,scaleY:0.5698,x:128.7,y:264.25},0).wait(1).to({regX:-26.1,regY:-250.7,x:113.85,y:121.4},0).wait(1).to({y:121.45},0).wait(1).to({y:121.55},0).wait(1).to({y:121.7},0).wait(1).to({y:121.9},0).wait(1).to({y:122.2},0).wait(1).to({y:122.55},0).wait(1).to({y:123},0).wait(1).to({y:123.5},0).wait(1).to({y:124.15},0).wait(1).to({y:124.9},0).wait(1).to({y:125.8},0).wait(1).to({y:126.8},0).wait(1).to({y:127.9},0).wait(1).to({y:129},0).wait(1).to({y:130.05},0).wait(1).to({y:130.95},0).wait(1).to({y:131.75},0).wait(1).to({y:132.4},0).wait(1).to({y:132.9},0).wait(1).to({y:133.3},0).wait(1).to({y:133.55},0).wait(1).to({y:133.75},0).wait(1).to({y:133.85},0).wait(1).to({regX:0,regY:0,x:128.7,y:276.75},0).wait(158).to({regX:-26.1,regY:-250.7,scaleX:0.5697,scaleY:0.5697,x:113.8,y:133.9},0).wait(1).to({scaleX:0.5695,scaleY:0.5695},0).wait(1).to({scaleX:0.5691,scaleY:0.5691,y:133.8},0).wait(1).to({scaleX:0.5686,scaleY:0.5686,y:133.75},0).wait(1).to({scaleX:0.5679,scaleY:0.5679,x:113.85,y:133.7},0).wait(1).to({scaleX:0.5669,scaleY:0.5669,x:113.8,y:133.6},0).wait(1).to({scaleX:0.5658,scaleY:0.5658,y:133.5},0).wait(1).to({scaleX:0.5644,scaleY:0.5644,y:133.4},0).wait(1).to({scaleX:0.5628,scaleY:0.5628,y:133.25},0).wait(1).to({scaleX:0.5609,scaleY:0.5609,y:133.1},0).wait(1).to({scaleX:0.5586,scaleY:0.5586,y:132.85},0).wait(1).to({scaleX:0.556,scaleY:0.556,x:113.85,y:132.65},0).wait(1).to({scaleX:0.5531,scaleY:0.5531,x:113.8,y:132.4},0).wait(1).to({scaleX:0.5497,scaleY:0.5497,y:132.1},0).wait(1).to({scaleX:0.5458,scaleY:0.5458,y:131.7},0).wait(1).to({scaleX:0.5416,scaleY:0.5416,y:131.35},0).wait(1).to({scaleX:0.5368,scaleY:0.5368,x:113.85,y:130.9},0).wait(1).to({scaleX:0.5316,scaleY:0.5316,x:113.8,y:130.45},0).wait(1).to({scaleX:0.5261,scaleY:0.5261,y:129.95},0).wait(1).to({scaleX:0.5202,scaleY:0.5202,y:129.45},0).wait(1).to({scaleX:0.5143,scaleY:0.5143,x:113.85,y:128.9},0).wait(1).to({scaleX:0.5085,scaleY:0.5085,y:128.4},0).wait(1).to({scaleX:0.5029,scaleY:0.5029,x:113.9,y:127.9},0).wait(1).to({scaleX:0.4977,scaleY:0.4977,x:113.85,y:127.4},0).wait(1).to({scaleX:0.493,scaleY:0.493,x:113.9,y:127},0).wait(1).to({scaleX:0.4889,scaleY:0.4889,y:126.6},0).wait(1).to({scaleX:0.4854,scaleY:0.4854,y:126.3},0).wait(1).to({scaleX:0.4824,scaleY:0.4824,x:113.85,y:126},0).wait(1).to({scaleX:0.4799,scaleY:0.4799,x:113.9,y:125.8},0).wait(1).to({scaleX:0.4778,scaleY:0.4778,y:125.6},0).wait(1).to({scaleX:0.4762,scaleY:0.4762,x:113.85,y:125.45},0).wait(1).to({scaleX:0.4749,scaleY:0.4749,x:113.9,y:125.35},0).wait(1).to({scaleX:0.474,scaleY:0.474,y:125.25},0).wait(1).to({scaleX:0.4734,scaleY:0.4734},0).wait(1).to({scaleX:0.473,scaleY:0.473,y:125.15},0).wait(1).to({regX:0,regY:0.1,scaleX:0.4729,scaleY:0.4729,x:126.25,y:243.75},0).wait(93).to({alpha:0.0117},12,cjs.Ease.get(1)).to({_off:true},1).wait(846));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({scaleX:0.5698,scaleY:0.5698,x:-56.55,y:-54.8},0).wait(1).to({regX:300,regY:350,x:114.4,y:144.65},0).wait(1).to({y:144.7},0).wait(1).to({y:144.8},0).wait(1).to({y:144.95},0).wait(1).to({y:145.15},0).wait(1).to({y:145.45},0).wait(1).to({y:145.8},0).wait(1).to({y:146.25},0).wait(1).to({y:146.75},0).wait(1).to({y:147.4},0).wait(1).to({y:148.15},0).wait(1).to({y:149.05},0).wait(1).to({y:150.05},0).wait(1).to({y:151.15},0).wait(1).to({y:152.25},0).wait(1).to({y:153.3},0).wait(1).to({y:154.2},0).wait(1).to({y:155},0).wait(1).to({y:155.65},0).wait(1).to({y:156.15},0).wait(1).to({y:156.55},0).wait(1).to({y:156.8},0).wait(1).to({y:157},0).wait(1).to({y:157.1},0).wait(1).to({regX:0,regY:0,x:-56.55,y:-42.3},0).wait(158).to({regX:300,regY:350,scaleX:0.5697,scaleY:0.5697,x:114.4,y:157.15},0).wait(1).to({scaleX:0.5695,scaleY:0.5695,y:157.1},0).wait(1).to({scaleX:0.5691,scaleY:0.5691,y:157.05},0).wait(1).to({scaleX:0.5686,scaleY:0.5686,x:114.45,y:157},0).wait(1).to({scaleX:0.5679,scaleY:0.5679,x:114.4,y:156.9},0).wait(1).to({scaleX:0.5669,scaleY:0.5669,y:156.8},0).wait(1).to({scaleX:0.5658,scaleY:0.5658,y:156.65},0).wait(1).to({scaleX:0.5644,scaleY:0.5644,x:114.45,y:156.45},0).wait(1).to({scaleX:0.5628,scaleY:0.5628,x:114.4,y:156.2},0).wait(1).to({scaleX:0.5609,scaleY:0.5609,y:156},0).wait(1).to({scaleX:0.5586,scaleY:0.5586,y:155.65},0).wait(1).to({scaleX:0.556,scaleY:0.556,y:155.35},0).wait(1).to({scaleX:0.5531,scaleY:0.5531,y:154.95},0).wait(1).to({scaleX:0.5497,scaleY:0.5497,y:154.55},0).wait(1).to({scaleX:0.5458,scaleY:0.5458,y:154},0).wait(1).to({scaleX:0.5416,scaleY:0.5416,y:153.45},0).wait(1).to({scaleX:0.5368,scaleY:0.5368,y:152.85},0).wait(1).to({scaleX:0.5316,scaleY:0.5316,y:152.15},0).wait(1).to({scaleX:0.5261,scaleY:0.5261,y:151.4},0).wait(1).to({scaleX:0.5202,scaleY:0.5202,y:150.7},0).wait(1).to({scaleX:0.5143,scaleY:0.5143,y:149.9},0).wait(1).to({scaleX:0.5085,scaleY:0.5085,y:149.1},0).wait(1).to({scaleX:0.5029,scaleY:0.5029,y:148.4},0).wait(1).to({scaleX:0.4977,scaleY:0.4977,y:147.75},0).wait(1).to({scaleX:0.493,scaleY:0.493,y:147.1},0).wait(1).to({scaleX:0.4889,scaleY:0.4889,y:146.6},0).wait(1).to({scaleX:0.4854,scaleY:0.4854,y:146.15},0).wait(1).to({scaleX:0.4824,scaleY:0.4824,y:145.75},0).wait(1).to({scaleX:0.4799,scaleY:0.4799,y:145.4},0).wait(1).to({scaleX:0.4778,scaleY:0.4778,y:145.15},0).wait(1).to({scaleX:0.4762,scaleY:0.4762,y:144.9},0).wait(1).to({scaleX:0.4749,scaleY:0.4749,x:114.35,y:144.75},0).wait(1).to({scaleX:0.474,scaleY:0.474,x:114.4,y:144.65},0).wait(1).to({scaleX:0.4734,scaleY:0.4734,y:144.55},0).wait(1).to({scaleX:0.473,scaleY:0.473,y:144.5},0).wait(1).to({regX:-0.1,regY:0,scaleX:0.4729,scaleY:0.4729,x:-27.5,y:-21.05},0).wait(93).to({alpha:0.0117},12,cjs.Ease.get(1)).to({_off:true},1).wait(846));

	// ch
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-291.35,243.75,0.4729,0.4729,0,0,0,0,0.1);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(197).to({_off:false},0).wait(129).to({regX:0.1,scaleX:0.6455,scaleY:0.6455,x:130.6,y:286.45},0).wait(1).to({regX:-26.1,regY:-250.7,x:113.7,y:124.6},0).wait(1).to({y:124.75},0).wait(1).to({y:125.05},0).wait(1).to({y:125.5},0).wait(1).to({y:126.2},0).wait(1).to({y:127.15},0).wait(1).to({y:128.3},0).wait(1).to({y:129.4},0).wait(1).to({y:130.25},0).wait(1).to({y:130.75},0).wait(1).to({y:131},0).wait(1).to({regX:0.1,regY:0.1,x:130.6,y:292.95},0).wait(152).to({regX:-26.1,regY:-250.7,x:113.7,y:131.05},0).wait(1).to({scaleX:0.6458,scaleY:0.6458},0).wait(1).to({scaleX:0.6461,scaleY:0.6461},0).wait(1).to({scaleX:0.6467,scaleY:0.6467,x:113.65},0).wait(1).to({scaleX:0.6476,scaleY:0.6476},0).wait(1).to({scaleX:0.6487,scaleY:0.6487,y:131.1},0).wait(1).to({scaleX:0.6502,scaleY:0.6502,x:113.7},0).wait(1).to({scaleX:0.652,scaleY:0.652,x:113.65},0).wait(1).to({scaleX:0.6543,scaleY:0.6543,x:113.6},0).wait(1).to({scaleX:0.657,scaleY:0.657,x:113.65,y:131.15},0).wait(1).to({scaleX:0.66,scaleY:0.66,x:113.6,y:131.2},0).wait(1).to({scaleX:0.6629,scaleY:0.6629},0).wait(1).to({scaleX:0.6655,scaleY:0.6655},0).wait(1).to({scaleX:0.6675,scaleY:0.6675},0).wait(1).to({scaleX:0.6691,scaleY:0.6691},0).wait(1).to({scaleX:0.6701,scaleY:0.6701,x:113.55,y:131.25},0).wait(1).to({scaleX:0.6708,scaleY:0.6708,x:113.6},0).wait(1).to({scaleX:0.6712,scaleY:0.6712},0).wait(1).to({regX:0,regY:0,scaleX:0.6713,scaleY:0.6713,x:131.15,y:299.6},0).wait(308).to({regX:-26.1,regY:-250.7,scaleX:0.6711,scaleY:0.6711,x:113.6,y:131.25},0).wait(1).to({scaleX:0.6703,scaleY:0.6703,y:131.2},0).wait(1).to({scaleX:0.669,scaleY:0.669,y:131.1},0).wait(1).to({scaleX:0.6669,scaleY:0.6669,y:130.9},0).wait(1).to({scaleX:0.6639,scaleY:0.6639,y:130.65},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,x:113.65,y:130.35},0).wait(1).to({scaleX:0.6544,scaleY:0.6544,x:113.6,y:129.85},0).wait(1).to({scaleX:0.6475,scaleY:0.6475,x:113.65,y:129.3},0).wait(1).to({scaleX:0.6395,scaleY:0.6395,y:128.6},0).wait(1).to({scaleX:0.6313,scaleY:0.6313,y:127.9},0).wait(1).to({scaleX:0.6241,scaleY:0.6241,y:127.3},0).wait(1).to({scaleX:0.6186,scaleY:0.6186,x:113.7,y:126.8},0).wait(1).to({scaleX:0.6149,scaleY:0.6149,y:126.5},0).wait(1).to({scaleX:0.6125,scaleY:0.6125,y:126.3},0).wait(1).to({scaleX:0.6112,scaleY:0.6112,y:126.15},0).wait(1).to({regX:0.1,regY:0.1,scaleX:0.6109,scaleY:0.6109,x:129.65,y:279.3},0).wait(126).to({regX:0.2,scaleX:0.4973,scaleY:0.4973,x:126.9,y:242.35},0).to({_off:true},189).wait(39));

	// bg
	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-445.1,-21.05,0.4729,0.4729,0,0,0,-0.1,0);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(197).to({_off:false},0).wait(129).to({regX:-0.3,regY:-0.1,scaleX:0.6455,scaleY:0.6455,x:-79.3,y:-74.95},0).wait(1).to({regX:300,regY:350,x:114.55,y:151.05},0).wait(1).to({y:151.2},0).wait(1).to({y:151.5},0).wait(1).to({y:151.95},0).wait(1).to({y:152.65},0).wait(1).to({y:153.6},0).wait(1).to({y:154.75},0).wait(1).to({y:155.85},0).wait(1).to({y:156.7},0).wait(1).to({y:157.2},0).wait(1).to({y:157.45},0).wait(1).to({regX:-0.3,regY:-0.1,x:-79.3,y:-68.45},0).wait(152).to({regX:300,regY:350,x:114.55,y:157.55},0).wait(1).to({scaleX:0.6458,scaleY:0.6458,x:114.6},0).wait(1).to({scaleX:0.6461,scaleY:0.6461,x:114.55},0).wait(1).to({scaleX:0.6467,scaleY:0.6467,y:157.6},0).wait(1).to({scaleX:0.6476,scaleY:0.6476,y:157.65},0).wait(1).to({scaleX:0.6487,scaleY:0.6487,y:157.7},0).wait(1).to({scaleX:0.6502,scaleY:0.6502,x:114.6,y:157.75},0).wait(1).to({scaleX:0.652,scaleY:0.652,x:114.55,y:157.85},0).wait(1).to({scaleX:0.6543,scaleY:0.6543,x:114.6,y:157.95},0).wait(1).to({scaleX:0.657,scaleY:0.657,x:114.55,y:158.1},0).wait(1).to({scaleX:0.66,scaleY:0.66,x:114.6,y:158.25},0).wait(1).to({scaleX:0.6629,scaleY:0.6629,x:114.55,y:158.4},0).wait(1).to({scaleX:0.6655,scaleY:0.6655,x:114.6,y:158.55},0).wait(1).to({scaleX:0.6675,scaleY:0.6675,y:158.65},0).wait(1).to({scaleX:0.6691,scaleY:0.6691,y:158.7},0).wait(1).to({scaleX:0.6701,scaleY:0.6701,y:158.8},0).wait(1).to({scaleX:0.6708,scaleY:0.6708,y:158.85},0).wait(1).to({scaleX:0.6712,scaleY:0.6712},0).wait(1).to({regX:-0.2,regY:-0.1,scaleX:0.6713,scaleY:0.6713,x:-87,y:-76.15},0).wait(308).to({regX:300,regY:350,scaleX:0.6711,scaleY:0.6711,x:114.55,y:158.85},0).wait(1).to({scaleX:0.6703,scaleY:0.6703,y:158.75},0).wait(1).to({scaleX:0.669,scaleY:0.669,y:158.6},0).wait(1).to({scaleX:0.6669,scaleY:0.6669,y:158.3},0).wait(1).to({scaleX:0.6639,scaleY:0.6639,x:114.6,y:157.9},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,x:114.55,y:157.45},0).wait(1).to({scaleX:0.6544,scaleY:0.6544,y:156.75},0).wait(1).to({scaleX:0.6475,scaleY:0.6475,y:155.85},0).wait(1).to({scaleX:0.6395,scaleY:0.6395,y:154.85},0).wait(1).to({scaleX:0.6313,scaleY:0.6313,y:153.8},0).wait(1).to({scaleX:0.6241,scaleY:0.6241,y:152.9},0).wait(1).to({scaleX:0.6186,scaleY:0.6186,y:152.2},0).wait(1).to({scaleX:0.6149,scaleY:0.6149,y:151.75},0).wait(1).to({scaleX:0.6125,scaleY:0.6125,y:151.4},0).wait(1).to({scaleX:0.6112,scaleY:0.6112,y:151.3},0).wait(1).to({regX:-0.3,regY:-0.1,scaleX:0.6109,scaleY:0.6109,x:-68.9,y:-62.65},0).wait(126).to({regY:-0.2,scaleX:0.4973,scaleY:0.4973,x:-34.75,y:-36.05},0).to({_off:true},189).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1134).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1146).wait(34).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-325,-720,1085.1,1383);
// library properties:
lib.properties = {
	id: '_419_3',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1601273922805", id:"_419_3_bg"},
		{src:"images/ch_base.png?1601273922805", id:"_419_3_ch_base"},
		{src:"images/ch_face2.png?1601273922805", id:"_419_3_ch_face2"},
		{src:"images/ch_face3.png?1601273922805", id:"_419_3_ch_face3"},
		{src:"images/ch_face4.png?1601273922805", id:"_419_3_ch_face4"},
		{src:"images/ch_face5.png?1601273922805", id:"_419_3_ch_face5"},
		{src:"images/ch_face6.png?1601273922805", id:"_419_3_ch_face6"},
		{src:"images/ch_face7.png?1601273922805", id:"_419_3_ch_face7"},
		{src:"images/ch_face8.png?1601273922805", id:"_419_3_ch_face8"},
		{src:"images/finish.jpg?1601273922805", id:"_419_3_finish"},
		{src:"images/finish_blur.jpg?1601273922805", id:"_419_3_finish_blur"},
		{src:"images/tie_fp.png?1601273922805", id:"_419_3_tie_fp"},
		{src:"images/tie_sp.png?1601273922805", id:"_419_3_tie_sp"}
	],
	preloads: []
};
